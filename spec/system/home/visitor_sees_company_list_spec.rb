...
describe 'Visitor sees companies list' do
  it 'only active companies' do
    ...
    company3 = Company.create!(owner_id: owner3.id, brand_name: 'Alegrias e Festas', corporate_name: 'Alegrias e Festas Eventos Ltda',
                              ...
                              description: 'Especializados em eventos corporativos e sociais, Alegrias e Festas oferece experiências gastronômicas únicas.', status: :inactive)
    ...
    company4 = Company.create!(owner_id: owner4.id, brand_name: 'Gourmet Celebration', corporate_name: 'Gourmet Celebration Buffet Ltda',
                              ...
                              description: 'Gourmet Celebration é sinônimo de elegância e sofisticação em buffets para casamentos e eventos corporativos.', status: :inactive)
