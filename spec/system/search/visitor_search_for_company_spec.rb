...
describe 'User searches for a company' do
  ...
  it 'and finds several companies by brand name' do
    ...
    company1 = Company.create!(supplier_id: supplier1.id, brand_name: 'Buffet dos Sonhos', corporate_name: 'Buffet dos Sonhos Ltda',
    ...
    company5 = Company.create!(supplier_id: supplier5.id, brand_name: 'Buffet Casamento Encantado', corporate_name: 'Buffet Encantado Eventos Ltda',
  ...
  it 'and finds several companies by city' do
    ...
    supplier2 = Supplier.create!(name: 'Roberto', lastname: 'Carvalho', email: 'roberto@email.com', password: '87654321')
    company2 = Company.create!(supplier_id: supplier2.id, brand_name: 'Buffet dos Casamentos', corporate_name: 'Buffet dos Sonhos Ltda',
                              registration_number: '14.429.522/0001-18', phone_number: '(11) 3344-5566', email: 'contato@buffetdossonhos.com',
                              address: 'Rua das Festas, 500', neighborhood: 'Jardim das Flores', city: 'Rio de Janeiro', state: 'RJ', zipcode: '06060-060',
                              description: 'Buffet dos Sonhos transforma sua festa em um evento inesquecível, com cardápios personalizados para todas as idades.')
